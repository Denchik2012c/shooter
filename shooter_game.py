...
display.set_caption("Space var")

img_back = "galaxy.jpg"
img_hero = "rocket.png"
img_enemy1 = "ufo.png"
img_enemy2 = "pizza.png"
...
for i in range(5):
    monster = Enemy(img_enemy1, randint(80, width - 80), -40, randint(1, 1), 80, 50)
    monsters.add(monster)

asteroids = sprite.Group()
for i in range(5):
    asteroid = Enemy(img_enemy2, randint(0, width - 50), -40, randint(1,1), 50, 50)
